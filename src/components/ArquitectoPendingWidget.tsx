...
interface ArquitectoPendingWidgetProps {
    ...
    onClose?: () => void; // Added for the new Drawer functionality
    isAnalyzing?: boolean;
}
...
const ArquitectoPendingWidget: React.FC<ArquitectoPendingWidgetProps> = ({
    ...
    return (
        <div className="w-full bg-[#0a0a0a] border-b border-titanium-800 transition-all duration-300 ease-in-out z-20 shadow-lg shadow-black/50" style={{ height: '320px' }}>
            <div className="max-w-7xl mx-auto h-full flex flex-col">
                ...
                <div className="flex-1 overflow-hidden py-6 px-6 bg-[#0a0a0a]">
